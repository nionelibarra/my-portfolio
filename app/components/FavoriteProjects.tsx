        ...
        <div className='mt-4'>
          ...
          <div className='mt-3 flex flex-wrap gap-2 font-semibold'>
            {item.tags.map((tagItem, index) => (
              <span className='inline-flex items-center rounded-md bg-primary/10 px-3 py-1.5 text-xs sm:text-sm mb-5 font-bold text-primary ring-2 rinng-inset ring-primary/20' key={index}>{tagItem}</span>
            ))}
          </div>
        </div>
      </a>
